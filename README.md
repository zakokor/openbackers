...
`<a href="http://openbackers.com" target="_blank"><img src="http://openbackers.com/banner" alt="Open Backers" width="224px" height="90px" /></a>`
...
<rect x="0" y="0" rx="5" width="224" height="90" fill="#f9f9f9"/>
	...
	<text text-anchor="end" x="220" y="100" shape-inside="rectangle(50,10,200,80)" font-family="sans-serif" font-size="10px" fill="#999">
		https://pegao.co
	</text>
</svg>
```
